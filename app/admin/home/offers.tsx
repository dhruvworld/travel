...
export default function OffersEditor() {
  ...
  const handleAddOffer = async () => {
    ...
    try {
      const response = await axios.post('/api/admin/offers', form);
  ...
  return (
    <div className="space-y-6">
      <p className="text-sm text-gray-600 mb-4">
        Create special offers to display on your homepage. Offers can promote discounts, special packages, or seasonal deals.
      </p>
