    ...
    <header className={`sticky top-0 z-50 w-full transition-all duration-200 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-1">
            ...
            <Link 
              href="/admin" 
              className="ml-4 px-4 py-2 rounded-md shadow-sm text-sm font-medium text-white bg-gradient-to-r from-indigo-600 to-blue-500 hover:from-indigo-700 hover:to-blue-600 transition-all duration-300"
            >
              Admin
            </Link>
          </nav>
      ...
      >
        <nav className="px-4 pt-2 pb-4 space-y-1 bg-white">
          ...
          <Link
            href="/admin"
            className="block px-3 py-2 rounded-md text-base font-medium text-white bg-gradient-to-r from-indigo-600 to-blue-500"
          >
            Admin Dashboard
          </Link>
        </nav>
